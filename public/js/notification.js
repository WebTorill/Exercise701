(function (window) {
  ...
  function subscribePush() {
    navigator.serviceWorker.ready.then(function(registration) {
      ...
      .then(function (subscription) {
        //TODO: What do we do to subscribe?
        //we save the subscription ID
        //we change the push status
        //we give the user notice through a toast message
        //we log the info to the console
      })
      .catch(function (error) {
        changePushStatus(false);
    ...
    .then(function(registration) {
      ...
      .then(function (subscription) {
        ...
        subscription.unsubscribe()
          .then(function () {
            //TODO: what do we do to delete the subsription?
            //Hint: the steps are almost the same as to subscribe
          })
          .catch(function (error) {
            console.error(error);
          });
